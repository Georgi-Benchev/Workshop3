...
public class CreateAirplaneCommand implements Command {
    ...
    public String execute(List<String> parameters) {
        ...
        return String.format(CommandsConstants.VEHICLE_CREATED_MESSAGE, createAirplane.getId());
    }
    ...
    private void parseParameters(List<String> parameters) {
        ...
        hasFreeFood = ParsingHelpers.tryParseBoolean(parameters.get(2), "hasFreeFood");
    }
